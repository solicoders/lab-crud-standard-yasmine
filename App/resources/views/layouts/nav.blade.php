    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                <img src="{{asset('images/man.png')}}" class="user-image img-circle elevation-2" alt="Image d'utilisateur">
                <span class="d-none d-md-inline">chef de Projets</span>
            </a>
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <!-- Image d'utilisateur -->
                <li class="user-header bg-info">
                    <img src="{{asset('images/man.png')}}" class="img-circle elevation-2" alt="Image d'utilisateur">
                    <p>
                    chef de Projets
